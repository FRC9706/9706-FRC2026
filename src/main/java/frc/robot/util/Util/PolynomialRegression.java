...
// squared residuals of the
//  * multiple regression model. It also computes associated the coefficient of determination
// <em>R</em><sup>2</sup>.
//  * <p>
...
//     /**
//      * Returns the expected response {@code y} given the value of the predictor variable {@code
// x}.
//      *
//      * @param x
//      *            the value of the predictor variable
//      * @return the expected response {@code y} given the value of the predictor variable {@code
// x}
//      */
